...
Вместо создания нового `interface` вы можете описать все, что вы хотите _встроенно_, используя `:{ /*Structure*/ }`. Предыдущий пример представлен снова уже как встроенный тип:
